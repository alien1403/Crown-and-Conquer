...
[CustomPropertyDrawer(typeof(GameObjectProbability))]
public class GameObjectProbabilityDrawer : PropertyDrawer
{
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        SerializedProperty layerSpeed = property.FindPropertyRelative("probability");
